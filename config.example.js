// ============================================================================
// Copy this file to config.js and paste the UNIFIED app's Apps Script Web App
// URL in below, after deploying it (see SETUP_INSTRUCTIONS.md in this folder's
// parent). config.js is gitignored on purpose — your real deployed URL should
// never be committed. It looks like:
//   https://script.google.com/macros/s/AKfycb.../exec
// ============================================================================
const API_URL = 'https://script.google.com/macros/s/AKfycbzW7h9VVDasPn5XGRZNHxYFa45slHoguECv_P9h67lpW8jW1JB0ZDCI1xy3vzRieFDWzg/exec';
